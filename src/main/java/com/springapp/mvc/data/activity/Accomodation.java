...
{
    public Accomodation(Long id, String name, Location location, Contact mainContact, Double geoX, Double geoY, String media)
    {
        super(id, name, location, mainContact, geoX, geoY, media);
    }
